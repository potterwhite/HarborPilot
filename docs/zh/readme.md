...
| **三层配置** | `defaults/` → `common.env` → `platform.env` · [查看详情 →](architecture/4-reference/config_layers.md) |
...
> **三层配置系统详解 →** [docs/zh/architecture/4-reference/config_layers.md](architecture/4-reference/config_layers.md)
