...
| **三层配置** | `defaults/` → `common.env` → `platform.env` · [查看详情 →](config_layers.md) |
...
└── docs/
    ├── en/                           ← 英文文档树
    │   ├── architecture/             AI 文档系统（英文）
    │   ├── config_layers.md          三层配置系统详解（英文）
    │   ├── quick_start.md            快速上手指南（英文）
    │   └── port-map-calculation.md   端口公式说明
    └── zh/                           ← 中文文档树
        ├── architecture/             AI 文档系统（中文）
        ├── config_layers.md          三层配置系统详解（中文）
        ├── quick_start.md            快速上手指南（中文）
        └── readme.md                 中文 README
```

> **三层配置系统详解 →** [docs/zh/config_layers.md](config_layers.md)
