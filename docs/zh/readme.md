...
- **一条命令启动** — `entrance.sh start` 在任意 Ubuntu 宿主机上秒级拉起完整配置的开发容器
...
| **三层配置** | `defaults/` → `platform.env` → `host.env` · [查看详情 →](4-reference/config_layers.md) |
...
└── docs/
    ├── en/                           ← 英文文档树
    │   └── architecture/             AI 文档系统（英文，含 1-for-ai / 2-progress / 3-highlights / 4-reference）
    └── zh/                           ← 中文文档树
        ├── architecture/             AI 文档系统（中文，含 1-for-ai / 2-progress / 3-highlights / 4-reference）
        └── readme.md                 中文 README
```

> **三层配置系统详解 →** [docs/zh/4-reference/config_layers.md](4-reference/config_layers.md)
...
→ **完整指南：[docs/zh/quick_start.md](quick_start.md)**
